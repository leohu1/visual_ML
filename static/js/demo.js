...
//            instance.addEndpoint("dragDropWindow3", { anchor: "RightMiddle" }, exampleEndpoint2);
...
//            instance.addEndpoint("dragDropWindow4", { anchor: "RightMiddle" }, exampleEndpoint2);

            // make .window divs draggable
            instance.draggable(jsPlumb.getSelector(".drag-drop-demo .window"));

            // add endpoint of type 3 using a selector.
            instance.addEndpoint(jsPlumb.getSelector(".drag-drop-demo .connect  "), InputPoint);
            instance.addEndpoint(jsPlumb.getSelector(".drag-drop-demo .connect "), OutputPoint);
            instance.addEndpoint(jsPlumb.getSelector(".drag-drop-demo .input "), OutputPoint);
